...
<body>
    ...
    <div class="container">
        <div class="container_form">
            <form action="process-reset-password.php" method="post" class="form">
                ...
                <div style="position: relative;">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="17" viewBox="0 0 25 17" fill="none" class="show-password-button">
