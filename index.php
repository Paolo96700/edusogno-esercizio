...
<div class="container">
    <div class="container_form">
        ...
        <form action="./login/login-logic.php" method="post" class="form">
            ...
            <div class="link">
                <div class="link register">
                    <a href="register.php" class="text">Non hai ancora un profilo? <span class="power_link">Registrati</span></a>
                </div>
            
                <a href="forgot-password.php" class="text">Hai dimenticato la password? <span class="power_link">Clicca qui</span></a><br>
            </div>
