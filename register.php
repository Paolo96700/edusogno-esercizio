...
?>
    <div class="container">
        <div class="container_form">
            ...
            <form action="./register/register-logic.php" method="post" class="form">
                ...
                <div>
                    ...
                    <?php if (isset($_GET['nome'])) { ?>
                        <!-- Serve a fare in modo che ogni volta che c'è un errore, il nome scritto rimanga e il form non si resetti -->
                        <input 
                            type="text" 
                            name="nome" 
                            placeholder="Nome"
                ...
                <div class="cont_label">
                    ...
                    <?php if (isset($_GET['cognome'])) { ?>
                        <!-- Serve a fare in modo che ogni volta che c'è un errore, il cognome scritto rimanga e il form non si resetti -->
                        <input 
                            type="text" 
                            name="cognome" 
                            placeholder="Cognome"
